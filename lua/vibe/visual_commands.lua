---Visual command handling module for vibe.nvim
---Implements neo-tree-style visual mode exit and command processing
---@module 'vibe.visual_commands'
local M = {}
...
function M.get_files_from_visual_selection(visual_data)
  ...
  elseif tree_type == "nvim-tree" then
    logger.debug("visual_commands", "Processing nvim-tree visual selection from line", start_pos, "to", end_pos)
